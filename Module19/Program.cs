...
///¬опросы:
///1. ƒелаю LogIn, потом LogOut и снова LogIn в тот же аккаунт - вылетает ошибка InvalidOperationException: A second operation was started on this context instance before a previous operation completed. This is usually caused by different threads concurrently using the same instance of DbContext. For more information on how to avoid threading issues with DbContext, see https://go.microsoft.com/fwlink/?linkid=2097913. Ќе понимаю, как победить. 
///2. Logout как делать перед закрытием окна.  огда закрываю окно и снова вхожу, юзер остаетс€ авторизован.
